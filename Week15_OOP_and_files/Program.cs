...
{
    string[] tempArray = line.Split(new char[] { ';' }, StringSplitOptions.RemoveEmptyEntries);     //loome ajutine massiv, mis rebib andmeid
...
{
    string filePath = @"G:\Мой диск\TKTK\3 aasta\Programmeerimise alused\data\movies.txt";
    string[] dataFromFile= File.ReadAllLines(filePath);             // loome massivi
    return dataFromFile;
}
